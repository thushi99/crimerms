    <header class="header navbar navbar-expand-lg navbar-dark bg-dark" style="padding-left: 10px;background-color:#34495e;">
                <div class="logo-container">
                    <a href="dashboard.php" class="logo" style="color:#000; font-size:22px;color:#fff;">
                    <img src="../assets/images/logo.png" alt="Admin" width="85px" style="padding-right: 10px;"/>Crime Record Management System | Admin Panel
                    </a>
